            ...
            <div class="container-fluid">
                <div class="col-lg-12">
                    <div class="card card-outline-primary">
                        ...
                        <div class="card-body">
                            <!-- Perhatikan action route yang sesuai dan tambahkan csrf token -->
                            <form action="{{ route('admin.menues.save') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row p-t-20">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="d_name" value="" class="form-control" placeholder="Morzirella" required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group has-danger">
                                                <label class="control-label">About</label>
                                                <input type="text" name="about" value="" class="form-control form-control-danger" placeholder="slogan" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row p-t-20">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="price" value="" class="form-control" placeholder="Rp." required>
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group has-danger">
