...
<body class="home">
    ...
    <section class="hero bg-image" data-image-src="images/other_img/pimg.jpg">
        <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                <h1>Rangkai Rasa Restaurant!</h1>
                ...
                <div class="steps">
                    ...
                    <div class="step-item step3">
                        ...
                        <h4><span style="color:white;">3. </span>Pay on Cashier!</h4>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                    <div class="food-item-wrap">
                        <img src="{{ asset('Res_img/dishes/' . $dish->img) }}" alt="{{ $dish->title }}" class="food-item-image">
                        <div class="content">
                            <h5><a href="{{ url('dishes', ['res_id' => $dish->rs_id]) }}">{{ $dish->title }}</a></h5>
                            <div class="product-name">{{ $dish->slogan }}</div>
                            <div class="price-btn-block">
                                <span class="price">Rp.{{ $dish->price }}</span>
                                <a href="{{ url('dishes', ['res_id' => $dish->rs_id]) }}" class="btn theme-btn-dash pull-right">Order Now</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row how-it-works-solution">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                        <div class="step step-3">
                            ...
                            <h3>Dine in or Take Home</h3>
                            <p>Get your food! And enjoy your meal! </p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="restaurant-listing">
                    ...
                    @php
                    $category = DB::table('res_category')->where('c_id', $restaurant->c_id)->first();
                    @endphp
                    <div class="col-xs-12 col-sm-12 col-md-6 single-restaurant all {{ $category->c_name }}">
                        <div class="restaurant-wrap">
                            <div class="row">
                                <div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
                                    <a class="restaurant-logo" href="{{ url('dishes', ['res_id' => $restaurant->rs_id]) }}">
